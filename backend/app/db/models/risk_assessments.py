...
class RiskAssessment(Base):
    ...
    weather_snapshot_id: Mapped[UUID | None] = mapped_column(ForeignKey("weather_snapshots.id"), nullable=True)
    ...
    weather_snapshot: Mapped["WeatherSnapshot | None"] = relationship(back_populates="risk_assessments")
